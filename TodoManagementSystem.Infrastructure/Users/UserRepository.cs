...
namespace TodoManagementSystem.Infrastructure.Users
{
    public sealed class UserRepository : IUserRepository
    {
        ...
        public async Task SaveAsync(User user)
        {
            ...
            if (exists) await UpdateAsync(_dbContext, user);
            else await SaveNewAsync(_dbContext, user);
        }
        ...
        private static async Task UpdateAsync(AppDbContext dbContext, User user)
        {
            ...
            var (userDataModel, userProfileDataModel) =
                Transfer(foundUserDataModel, foundUserProfileDataModel, user);

            dbContext.Users.Update(userDataModel);
            dbContext.UserProfiles.Update(userProfileDataModel);
        ...
        private static async Task SaveNewAsync(AppDbContext dbContext, User user)
        {
            ...
            var (userDataModel, userProfileDataModel) = ToDataModel(user);
